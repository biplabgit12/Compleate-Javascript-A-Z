...
nextBtn.onclick = () => {
    // let randNum = Math.floor(Math.random()*165);
    let randNum = Math.floor(Math.random() * (Jokes.length - 1));
    console.log(randNum);

    let luckyJoke = Jokes[randNum];
    // console.log(luckyJoke);
    let joke = document.getElementById("joke");
    joke.innerHTML = `" ` + luckyJoke + ` "`;
